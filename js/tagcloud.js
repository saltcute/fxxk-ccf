    ...
    TagCloud.prototype = {
        ...
        update: function () {
            ...
            for (var j = 0, len = self.items.length; j < len; j++) {
				...
				var updateFontSize = self.fontsize;
				var curzIndex = self.items[j].element.style.zIndex;
				if(curzIndex < 3){
					updateFontSize = 12;
				} else if(curzIndex == 3){
					updateFontSize = 14;
					...
					updateFontSize = 20;
				} else if(curzIndex == 10){
					updateFontSize = 21;
				} else if(curzIndex == 11){
					updateFontSize = 22;
				} else {
					updateFontSize = 24;
				}
                ...
                if(self.index==j){
                    ...
                    self.items[j].fontsize = updateFontSize;
                ...
                self.items[j].element.style.fontSize = updateFontSize + "px";
				self.items[j].element.style.left = (self.items[j].x * 2 + (self.box.offsetWidth - self.items[j].offsetWidth) / 2 - 20) + "px";
